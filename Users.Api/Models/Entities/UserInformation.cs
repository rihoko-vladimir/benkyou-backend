...
public class UserInformation
{
    ...
    {
        return Id.Equals(other.Id) && FirstName == other.FirstName && LastName == other.LastName && UserName == other.UserName && UserRole == other.UserRole && Nullable.Equals(BirthDay, other.BirthDay) && AvatarUrl == other.AvatarUrl && IsTermsAccepted == other.IsTermsAccepted && IsAccountPublic == other.IsAccountPublic && About == other.About;
    }
