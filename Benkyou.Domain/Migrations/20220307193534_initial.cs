    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CardsCreatedCount = table.Column<int>(type: "int", nullable: false),
                    LastTimeStudied = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KunyomiList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KunyomiList_KanjiList_KanjiId",
                        column: x => x.KanjiId,
                        principalTable: "KanjiList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnyomiList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OnyomiList_KanjiList_KanjiId",
                        column: x => x.KanjiId,
                        principalTable: "KanjiList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
